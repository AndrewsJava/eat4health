...
public class Eat4HealthViewPagerTest extends Eat4HealthNavDrawerSetup {
	...
	public void setUpViewPager() {
		...
		pager = ViewFactory.basicViewPager();
		pager.setAdapter(pagerAdapter);

		// Create an initial view to display; must be a subclass of FrameLayout.
		LinearLayout v0 = new LinearLayout(this);
	...
	class MainPagerAdapter extends PagerAdapter {
		...
		// is our job
		// to add the page to the container, which is normally the ViewPager
		// itself. Since
		...
		// finishUpdate - called by the ViewPager - we don't care about what
		// pages the

...
public class GeneralLoadingThread implements Runnable {
	...
	int[][] map;
	int readCount = 0;
	public static final int FOOD = 10000203;
	...
	public GeneralLoadingThread(Context context, String[] info, String[] units, String objFile) {
		this.context = context;
		this.info = info;
		this.units = units;
		this.fromFile = objFile;
	...
	public GeneralLoadingThread(Context context, String[] info, int[][] mapping, String objFile, int type) {
		this.context = context;
		this.info = info;
		this.map = mapping;
		this.fromFile = objFile;
	...
	public void run() {
		...
		System.out.println(fromFile + "--------------------------->" + threadTime);
	}

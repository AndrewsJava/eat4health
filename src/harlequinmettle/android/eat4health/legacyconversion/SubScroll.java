...
public class SubScroll extends ScrollView {
	...
	static final int MAX_BUTTON_WIDTH = 550;
	...
	public void addScrollingButtons(String[] buttonNames, int[] buttonIds, View.OnClickListener listener, int BUTTON_CLR) {
		...
		this.getViewTreeObserver().addOnGlobalLayoutListener(new RandomScroller(this));
	...
	public static RadioButton simpleRadioButton() {
		...
		button.setMaxWidth(MAX_BUTTON_WIDTH);
		button.setMaxLines(5);
		button.setTextSize(TypedValue.COMPLEX_UNIT_DIP, Eat4Health.TEXT_SMALL);
		return button;
	}
	...
	public static TextView textView() {
		...
		ta.setMaxLines(5);
		ta.setTextSize(TypedValue.COMPLEX_UNIT_DIP, Eat4Health.TEXT_MED);
		return ta;
	}
	...
	static EditText editText(String hint) {
		EditText editText = new EditText(ContextReference.getAppContext());
